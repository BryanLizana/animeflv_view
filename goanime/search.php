...
$html_anime = classAnime::get_url_contents('https://www5.gogoanime.in//search.html?keyword='.$_REQUEST['keyword'].'&page='.$_REQUEST['page'].'');
...
$html_anime = str_replace('="/img','="https://www5.gogoanime.in/img',$html_anime);
