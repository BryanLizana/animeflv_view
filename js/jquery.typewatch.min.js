! function(e, t) {
    ...
    e.fn.typeWatch = function(t) {
        function n(e, t) {
            ...
            (n.length >= r.captureLength && n != e.text || t && (n.length >= r.captureLength || r.allowSubmit) || 0 == n.length && e.text) && (e.text = n, e.cb.call(e.el, n))
        }
        ...
        function i(e) {
            ...
            if (jQuery.inArray(t, r.inputTypes) >= 0) {
                ...
                r.highlight && "DIV" !== t && jQuery(e).focus(function() {
                    this.select()
                });
                var u = function(e) {
                    var u = i.wait,
                        r = !1,
                        a = t;
                    "undefined" != typeof e.keyCode && 13 == e.keyCode && "TEXTAREA" !== a && "DIV" !== t && (console.log("OVERRIDE"), u = 1, r = !0);
                    var c = function() {
                        n(i, r)
                    };
        ...
        var u = ["TEXT", "TEXTAREA", "PASSWORD", "TEL", "SEARCH", "URL", "EMAIL", "DATETIME", "DATE", "MONTH", "WEEK", "TIME", "DATETIME-LOCAL", "NUMBER", "RANGE", "DIV"],
            r = e.extend({
                wait: 750,
                callback: function() {},
                highlight: !0,
